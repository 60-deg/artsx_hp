...
class Teletype_Welcome {
	...
	public function teletype_welcome_admin_notice() {
		?>
			...
			<p><?php echo sprintf( esc_html__( 'You can get some points to theme installation on the %1$swelcome screen%2$s.', 'teletype' ), '<a href="' . esc_url( admin_url( 'themes.php?page=teletype-about' ) ) . '">', '</a>' ); ?></p>
